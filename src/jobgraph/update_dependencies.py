...
def _create_merge_request(
    ...
    main_branch = repo.get_default_branch(git_remote_name, short_format=True)

    merge_request_description = (
        "This merge request was automatically generated by jobgraph"
    )
    ...
    if job_name:
        ...
        merge_request_description = (
            f"{merge_request_description} in `{job_name}` ([{job_id}]({job_url}))."
        )
    ...
    repo.push(
        ...
        push_options=[
            ...
            f"merge_request.description={merge_request_description}",
